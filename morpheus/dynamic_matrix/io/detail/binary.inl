...
#ifndef MORPHEUS_DYNAMIC_MATRIX_IO_DETAIL_BINARY_INL
#define MORPHEUS_DYNAMIC_MATRIX_IO_DETAIL_BINARY_INL
...
namespace morpheus
{
	namespace io
	{
		...
		{
			apply_operation(mtx.types(), detail::read_binary_file_fn(filename));
		}
		...
		{
			apply_operation(mtx.types(), detail::write_binary_file_fn(filename));
		}

	}   // end namespace io
}   // end namespace morpheus

#endif  //MORPHEUS_DYNAMIC_MATRIX_IO_DETAIL_BINARY_INL