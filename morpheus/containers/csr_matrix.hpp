...
namespace Morpheus
{
    ...
    public:
        ...
        inline CsrMatrix(const index_type num_rows, const index_type num_cols, const index_type num_entries)
        ...
        { 
            ...
            Morpheus::NotImplementedException("CsrMatrix.swap(const CsrMatrix& matrix)");
        }
        ...
        { 
            ...
            Morpheus::NotImplementedException("CsrMatrix.operator=(const MatrixType& matrix)"); 
        }
