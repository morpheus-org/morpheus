...
namespace Morpheus
{
    ...
    public:
        ...
        inline DiaMatrix(const index_type num_rows, const index_type num_cols, const index_type num_entries,
        ...
        // Resize matrix dimensions and underlying storage
        inline void resize(const index_type num_rows, const index_type num_cols, const index_type num_entries,
                           const index_type num_diagonals, const index_type alignment)
        { 
            // TODO: resize(...)
            Morpheus::NotImplementedException("DiaMatrix.resize(...)"); 
        }
        ...
        void swap(DiaMatrix& matrix)
        {
            ...
            Morpheus::NotImplementedException("DiaMatrix.swap(const DiaMatrix& matrix)");
        }
