...
namespace Morpheus
{
    ...
    {   
        ...
        struct any_type_resize
        {
            ...
            result_type operator()(CooMatrix<IndexType,ValueType>& mat, 
                                   IndexType nrows, IndexType ncols, IndexType nnnz){
            ...
            result_type operator()(DiaMatrix<IndexType,ValueType>& mat, 
                                  IndexType nrows, IndexType ncols, IndexType nnnz,
                                  IndexType ndiag, IndexType alignment){
            ...
            result_type operator()(T& mat, Args&& ... args){
                ...
                throw std::runtime_error ("Error::Invalid use of the dynamic resize interface");
            }
        };
        ...
        struct any_type_get_name
		{
			...
			template <typename T>
			result_type operator()(T& mat) const { return mat.name(); }
		};

        struct any_type_get_nrows
		{
			template <typename T>
			typename T::index_type operator()(T& mat) const { return mat.nrows(); }
		};

        struct any_type_get_ncols
		{
			template <typename T>
			typename T::index_type operator()(T& mat) const { return mat.ncols(); }
		};

        struct any_type_get_nnnz
		{
			template <typename T>
			typename T::index_type operator()(T& mat) const { return mat.nnnz(); }
		};
    }
    ...
    private:
        using MatrixFormats = std::variant<Morpheus::CooMatrix<int,double>, 
                                            Morpheus::CsrMatrix<int,double>,
                                            Morpheus::DiaMatrix<int,double>,
                                            Morpheus::CooMatrix<int,double>>;
