...
#ifndef MORPHEUS_ALGORITHMS_IMPL_COO_MATRIX_SERIAL_MULTIPLY_IMPL_HPP
#define MORPHEUS_ALGORITHMS_IMPL_COO_MATRIX_SERIAL_MULTIPLY_IMPL_HPP
...
#endif  // MORPHEUS_ALGORITHMS_IMPL_COO_MATRIX_SERIAL_MULTIPLY_IMPL_HPP