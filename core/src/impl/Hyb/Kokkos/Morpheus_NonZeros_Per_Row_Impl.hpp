...
#ifndef MORPHEUS_HYB_KOKKOS_NON_ZEROS_PER_ROW_IMPL_HPP
#define MORPHEUS_HYB_KOKKOS_NON_ZEROS_PER_ROW_IMPL_HPP
...
inline void count_nnz_per_row(
  ...
  Impl::count_nnz_per_row<ExecSpace>(A.cell(), nnz_per_row, init);
  Impl::count_nnz_per_row<ExecSpace>(A.ccoo(), nnz_per_row, false);
}

}  // namespace Impl
}  // namespace Morpheus

#endif  // MORPHEUS_HYB_KOKKOS_NON_ZEROS_PER_ROW_IMPL_HPP