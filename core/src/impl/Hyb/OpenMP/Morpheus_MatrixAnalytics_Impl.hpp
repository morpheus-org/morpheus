...
#ifndef MORPHEUS_HYB_OPENMP_MATRIXANALYTICS_IMPL_HPP
#define MORPHEUS_HYB_OPENMP_MATRIXANALYTICS_IMPL_HPP
...
#endif  // MORPHEUS_HYB_OPENMP_MATRIXANALYTICS_IMPL_HPP