...
#ifndef MORPHEUS_HYB_SERIAL_MULTIPLY_IMPL_HPP
#define MORPHEUS_HYB_SERIAL_MULTIPLY_IMPL_HPP
...
inline void multiply(
  ...
  Impl::multiply<ExecSpace>(A.cell(), x, y, init);
  Impl::multiply<ExecSpace>(A.ccoo(), x, y, false);
}
...
#endif  // MORPHEUS_HYB_SERIAL_MULTIPLY_IMPL_HPP