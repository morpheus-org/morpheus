...
#ifndef MORPHEUS_HYB_CUDA_NON_ZEROS_PER_DIAGONAL_IMPL_HPP
#define MORPHEUS_HYB_CUDA_NON_ZEROS_PER_DIAGONAL_IMPL_HPP
...
#endif  // MORPHEUS_HYB_CUDA_NON_ZEROS_PER_DIAGONAL_IMPL_HPP