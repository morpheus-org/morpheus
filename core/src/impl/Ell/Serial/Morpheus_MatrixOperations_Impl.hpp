...
#ifndef MORPHEUS_ELL_SERIAL_MATRIXOPERATIONS_IMPL_HPP
#define MORPHEUS_ELL_SERIAL_MATRIXOPERATIONS_IMPL_HPP
...
#endif  // MORPHEUS_ELL_SERIAL_MATRIXOPERATIONS_IMPL_HPP
