...
#ifndef MORPHEUS_ELL_SERIAL_NON_ZEROS_PER_DIAGONAL_IMPL_HPP
#define MORPHEUS_ELL_SERIAL_NON_ZEROS_PER_DIAGONAL_IMPL_HPP
...
#endif  // MORPHEUS_ELL_SERIAL_NON_ZEROS_PER_DIAGONAL_IMPL_HPP