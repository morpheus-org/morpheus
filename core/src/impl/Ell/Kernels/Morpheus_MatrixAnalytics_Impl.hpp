...
#ifndef MORPHEUS_ELL_KERNELS_MATRIXANALYTICS_IMPL_HPP
#define MORPHEUS_ELL_KERNELS_MATRIXANALYTICS_IMPL_HPP
...
__launch_bounds__(BLOCK_SIZE, 1) __global__
    void count_nnz_per_row_ell_kernel(const SizeType num_rows,
...
#endif  // MORPHEUS_ELL_KERNELS_MATRIXANALYTICS_IMPL_HPP