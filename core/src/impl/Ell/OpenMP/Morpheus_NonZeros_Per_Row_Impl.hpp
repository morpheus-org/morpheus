...
#ifndef MORPHEUS_ELL_OPENMP_NON_ZEROS_PER_ROW_IMPL_HPP
#define MORPHEUS_ELL_OPENMP_NON_ZEROS_PER_ROW_IMPL_HPP
...
#endif  // MORPHEUS_ELL_OPENMP_NON_ZEROS_PER_ROW_IMPL_HPP