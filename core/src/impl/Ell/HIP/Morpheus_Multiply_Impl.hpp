...
#ifndef MORPHEUS_ELL_HIP_MULTIPLY_IMPL_HPP
#define MORPHEUS_ELL_HIP_MULTIPLY_IMPL_HPP
...
inline void multiply(
  ...
  getLastHIPError("spmv_ell_kernel: Kernel execution failed");
#endif
}
...
#endif  // MORPHEUS_ELL_HIP_MULTIPLY_IMPL_HPP