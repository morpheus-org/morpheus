...
#ifndef MORPHEUS_ELL_HIP_MATRIXOPERATIONS_IMPL_HPP
#define MORPHEUS_ELL_HIP_MATRIXOPERATIONS_IMPL_HPP
...
void update_diagonal(
  ...
  getLastHIPError("update_ell_diagonal_kernel: Kernel execution failed");
#endif
}
...
#endif  // MORPHEUS_ELL_HIP_MATRIXOPERATIONS_IMPL_HPP
