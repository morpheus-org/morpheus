...
#ifndef MORPHEUS_HDC_KOKKOS_NON_ZEROS_PER_DIAGONAL_IMPL_HPP
#define MORPHEUS_HDC_KOKKOS_NON_ZEROS_PER_DIAGONAL_IMPL_HPP
...
void count_nnz_per_diagonal(
  ...
  Impl::count_nnz_per_diagonal<ExecSpace>(A.cdia(), nnz_per_diagonal, init);
  Impl::count_nnz_per_diagonal<ExecSpace>(A.ccsr(), nnz_per_diagonal, false);
}

}  // namespace Impl
}  // namespace Morpheus

#endif  // MORPHEUS_HDC_KOKKOS_NON_ZEROS_PER_DIAGONAL_IMPL_HPP