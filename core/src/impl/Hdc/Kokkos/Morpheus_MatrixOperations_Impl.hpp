...
#ifndef MORPHEUS_HDC_KOKKOS_MATRIXOPERATIONS_IMPL_HPP
#define MORPHEUS_HDC_KOKKOS_MATRIXOPERATIONS_IMPL_HPP
...
#endif  // MORPHEUS_HDC_KOKKOS_MATRIXOPERATIONS_IMPL_HPP
