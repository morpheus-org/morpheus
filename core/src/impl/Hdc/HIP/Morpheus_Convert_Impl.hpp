...
#ifndef MORPHEUS_HDC_HIP_CONVERT_IMPL_HPP
#define MORPHEUS_HDC_HIP_CONVERT_IMPL_HPP
...
void convert(
    ...
    typename std::enable_if<
        ...
        nullptr) {
  throw Morpheus::NotImplementedException("convert<Kokkos::HIP>");
}
...
#endif  // MORPHEUS_HDC_HIP_CONVERT_IMPL_HPP