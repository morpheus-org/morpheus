...
#ifndef MORPHEUS_HDC_OPENMP_MATRIXANALYTICS_IMPL_HPP
#define MORPHEUS_HDC_OPENMP_MATRIXANALYTICS_IMPL_HPP
...
#endif  // MORPHEUS_HDC_OPENMP_MATRIXANALYTICS_IMPL_HPP