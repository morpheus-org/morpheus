...
#ifndef MORPHEUS_HDC_OPENMP_NON_ZEROS_PER_ROW_IMPL_HPP
#define MORPHEUS_HDC_OPENMP_NON_ZEROS_PER_ROW_IMPL_HPP
...
#endif  // MORPHEUS_HDC_OPENMP_NON_ZEROS_PER_ROW_IMPL_HPP