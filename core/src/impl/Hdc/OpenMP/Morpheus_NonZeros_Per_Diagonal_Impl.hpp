...
#ifndef MORPHEUS_HDC_OPENMP_NON_ZEROS_PER_DIAGONAL_IMPL_HPP
#define MORPHEUS_HDC_OPENMP_NON_ZEROS_PER_DIAGONAL_IMPL_HPP
...
#endif  // MORPHEUS_HDC_OPENMP_NON_ZEROS_PER_DIAGONAL_IMPL_HPP