...
#ifndef MORPHEUS_DIA_HIP_MATRIXOPERATIONS_IMPL_HPP
#define MORPHEUS_DIA_HIP_MATRIXOPERATIONS_IMPL_HPP
...
void update_diagonal(
  ...
  getLastHIPError("update_dia_diagonal_kernel: Kernel execution failed");
#endif
}
...
#endif  // MORPHEUS_DIA_HIP_MATRIXOPERATIONS_IMPL_HPP
