...
#ifndef MORPHEUS_DIA_HIP_NON_ZEROS_PER_ROW_IMPL_HPP
#define MORPHEUS_DIA_HIP_NON_ZEROS_PER_ROW_IMPL_HPP
...
inline void count_nnz_per_row(
  ...
  getLastHIPError("count_nnz_per_row_dia_kernel: Kernel execution failed");
#endif
}
...
#endif  // MORPHEUS_DIA_HIP_NON_ZEROS_PER_ROW_IMPL_HPP