...
#ifndef MORPHEUS_DIA_OPENMP_MATRIXANALYTICS_IMPL_HPP
#define MORPHEUS_DIA_OPENMP_MATRIXANALYTICS_IMPL_HPP
...
#endif  // MORPHEUS_DIA_OPENMP_MATRIXANALYTICS_IMPL_HPP