...
#ifndef MORPHEUS_DIA_KOKKOS_NON_ZEROS_PER_ROW_IMPL_HPP
#define MORPHEUS_DIA_KOKKOS_NON_ZEROS_PER_ROW_IMPL_HPP
...
#endif  // MORPHEUS_DIA_KOKKOS_NON_ZEROS_PER_ROW_IMPL_HPP