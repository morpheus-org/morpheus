...
#ifndef MORPHEUS_DIA_CUDA_NON_ZEROS_PER_DIAGONAL_IMPL_HPP
#define MORPHEUS_DIA_CUDA_NON_ZEROS_PER_DIAGONAL_IMPL_HPP
...
#endif  // MORPHEUS_DIA_CUDA_NON_ZEROS_PER_DIAGONAL_IMPL_HPP