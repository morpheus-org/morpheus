...
#ifndef MORPHEUS_DENSEVECTOR_OPENMP_COUNT_OCCURENCES_IMPL_HPP
#define MORPHEUS_DENSEVECTOR_OPENMP_COUNT_OCCURENCES_IMPL_HPP
...
#endif  // MORPHEUS_DENSEVECTOR_OPENMP_COUNT_OCCURENCES_IMPL_HPP