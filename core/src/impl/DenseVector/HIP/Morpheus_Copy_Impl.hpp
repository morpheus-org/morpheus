...
#ifndef MORPHEUS_DENSEVECTOR_HIP_COPY_IMPL_HPP
#define MORPHEUS_DENSEVECTOR_HIP_COPY_IMPL_HPP
...
void copy_by_key(
  ...
  getLastHIPError("copy_by_key_kernel: Kernel execution failed");
#endif
}
...
#endif  // MORPHEUS_DENSEVECTOR_HIP_COPY_IMPL_HPP
