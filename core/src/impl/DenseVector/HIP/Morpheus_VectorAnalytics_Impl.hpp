...
#ifndef MORPHEUS_DENSEVECTOR_HIP_VECTORANALYTICS_IMPL_HPP
#define MORPHEUS_DENSEVECTOR_HIP_VECTORANALYTICS_IMPL_HPP
...
#endif  // MORPHEUS_DENSEVECTOR_HIP_VECTORANALYTICS_IMPL_HPP