...
#ifndef MORPHEUS_DENSEVECTOR_HIP_COUNT_OCCURENCES_IMPL_HPP
#define MORPHEUS_DENSEVECTOR_HIP_COUNT_OCCURENCES_IMPL_HPP
...
#endif  // MORPHEUS_DENSEVECTOR_HIP_COUNT_OCCURENCES_IMPL_HPP