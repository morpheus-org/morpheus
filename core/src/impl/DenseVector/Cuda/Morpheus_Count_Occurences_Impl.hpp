...
#ifndef MORPHEUS_DENSEVECTOR_CUDA_COUNT_OCCURENCES_IMPL_HPP
#define MORPHEUS_DENSEVECTOR_CUDA_COUNT_OCCURENCES_IMPL_HPP
...
#endif  // MORPHEUS_DENSEVECTOR_CUDA_COUNT_OCCURENCES_IMPL_HPP