...
#ifndef MORPHEUS_CSR_SERIAL_MATRIXANALYTICS_IMPL_HPP
#define MORPHEUS_CSR_SERIAL_MATRIXANALYTICS_IMPL_HPP
...
#endif  // MORPHEUS_CSR_SERIAL_MATRIXANALYTICS_IMPL_HPP