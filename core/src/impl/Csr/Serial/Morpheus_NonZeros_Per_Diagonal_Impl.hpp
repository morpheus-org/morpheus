...
#ifndef MORPHEUS_CSR_SERIAL_NON_ZEROS_PER_DIAGONAL_IMPL_HPP
#define MORPHEUS_CSR_SERIAL_NON_ZEROS_PER_DIAGONAL_IMPL_HPP
...
#endif  // MORPHEUS_CSR_SERIAL_NON_ZEROS_PER_DIAGONAL_IMPL_HPP