...
#ifndef MORPHEUS_CSR_KOKKOS_MATRIXANALYTICS_IMPL_HPP
#define MORPHEUS_CSR_KOKKOS_MATRIXANALYTICS_IMPL_HPP
...
#endif  // MORPHEUS_CSR_KOKKOS_MATRIXANALYTICS_IMPL_HPP