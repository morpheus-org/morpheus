...
#ifndef MORPHEUS_CSR_OPENMP_NON_ZEROS_PER_ROW_IMPL_HPP
#define MORPHEUS_CSR_OPENMP_NON_ZEROS_PER_ROW_IMPL_HPP
...
#endif  // MORPHEUS_CSR_OPENMP_NON_ZEROS_PER_ROW_IMPL_HPP