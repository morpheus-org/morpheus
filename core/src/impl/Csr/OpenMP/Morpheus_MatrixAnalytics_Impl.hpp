...
#ifndef MORPHEUS_CSR_OPENMP_MATRIXANALYTICS_IMPL_HPP
#define MORPHEUS_CSR_OPENMP_MATRIXANALYTICS_IMPL_HPP
...
#endif  // MORPHEUS_CSR_OPENMP_MATRIXANALYTICS_IMPL_HPP