...
#ifndef MORPHEUS_COO_CUDA_NON_ZEROS_PER_ROW_IMPL_HPP
#define MORPHEUS_COO_CUDA_NON_ZEROS_PER_ROW_IMPL_HPP
...
#if defined(DEBUG) || defined(MORPHEUS_DEBUG)
  getLastCudaError(
      "count_nnz_per_row_coo_flat_kernel: Kernel execution failed");
#endif
...
#endif  // MORPHEUS_COO_CUDA_NON_ZEROS_PER_ROW_IMPL_HPP