...
#ifndef MORPHEUS_COO_HIP_NON_ZEROS_PER_DIAGONAL_IMPL_HPP
#define MORPHEUS_COO_HIP_NON_ZEROS_PER_DIAGONAL_IMPL_HPP
...
#endif  // MORPHEUS_COO_HIP_NON_ZEROS_PER_DIAGONAL_IMPL_HPP