...
#ifndef MORPHEUS_COO_HIP_SORT_IMPL_HPP
#define MORPHEUS_COO_HIP_SORT_IMPL_HPP
...
void sort_by_row_and_column(
    ...
    typename std::enable_if_t<
        ...
        Morpheus::has_hip_execution_space_v<ExecSpace>>* = nullptr) {
  throw Morpheus::NotImplementedException(
      "Impl.Coo.Cuda.sort_by_row_and_column()");
}
...
#endif  // MORPHEUS_COO_HIP_SORT_IMPL_HPP