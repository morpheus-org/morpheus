...
#ifndef MORPHEUS_COO_HIP_MATRIXOPERATIONS_IMPL_HPP
#define MORPHEUS_COO_HIP_MATRIXOPERATIONS_IMPL_HPP
...
void update_diagonal(
  ...
  getLastHIPError("update_coo_diagonal_kernel: Kernel execution failed");
#endif
}
...
#endif  // MORPHEUS_COO_HIP_MATRIXOPERATIONS_IMPL_HPP
