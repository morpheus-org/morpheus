...
#ifndef MORPHEUS_COO_OPENMP_NON_ZEROS_PER_DIAGONAL_IMPL_HPP
#define MORPHEUS_COO_OPENMP_NON_ZEROS_PER_DIAGONAL_IMPL_HPP
...
void count_nnz_per_diagonal(
  ...
  return Impl::count_nnz_per_diagonal<backend>(A, nnz_per_diagonal, init);
}
...
#endif  // MORPHEUS_COO_OPENMP_NON_ZEROS_PER_DIAGONAL_IMPL_HPP