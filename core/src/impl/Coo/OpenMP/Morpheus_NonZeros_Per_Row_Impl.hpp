...
#ifndef MORPHEUS_COO_OPENMP_NON_ZEROS_PER_ROW_IMPL_HPP
#define MORPHEUS_COO_OPENMP_NON_ZEROS_PER_ROW_IMPL_HPP
...
#endif  // MORPHEUS_COO_OPENMP_NON_ZEROS_PER_ROW_IMPL_HPP