...
#include <impl/Coo/Serial/Arm/Morpheus_Workspace.hpp>
...
void multiply_armpl_coo_serial(
  ...
  armpl_spmat_t armpl_mat = armplcoospace_serial.handle(
      M, N, nnnz, rind, cind, vals, ARMPL_SPARSE_CREATE_NOCOPY);
