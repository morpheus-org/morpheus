...
#ifndef MORPHEUS_COO_SERIAL_MATRIXANALYTICS_IMPL_HPP
#define MORPHEUS_COO_SERIAL_MATRIXANALYTICS_IMPL_HPP
...
#endif  // MORPHEUS_COO_SERIAL_MATRIXANALYTICS_IMPL_HPP