...
//     res = Morpheus::is_same_index_type<typename Vector::index_type,
//     int>::value; EXPECT_EQ(res, 1);
//   } else {
...
//         Vector, typename
//         Kokkos::DefaultExecutionSpace::execution_space>::value;
//     EXPECT_EQ(res, 1);
//     EXPECT_EQ(res, 1);
//   } else {
//     res =
...
//                        typename Vector::value_type, typename
//                        Vector::index_type, typename Vector::array_layout,
