...
TYPED_TEST(ConvertDynamicTypesTest, DynamicToSparseCuda) {
...
TYPED_TEST(ConvertDynamicTypesTest, SparseToDynamicCuda) {
...
TYPED_TEST(ConvertDynamicTypesTest, DynamicToDynamicCuda) {
  using src_t = typename TestFixture::dyn_dev_t;
  using dst_t = typename TestFixture::dyn_dev_t;
  src_t src   = this->con_ref;
  dst_t dst;
...
TYPED_TEST(ConvertDynamicTypesTest, DynamicInPlaceCuda) {
  using dst_t = typename TestFixture::dyn_dev_t;
...
#endif  // TEST_CORE_CUDA_TEST_CONVERT_HPP
