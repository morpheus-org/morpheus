...
#ifndef TEST_CORE_HIP_TEST_CONVERT_HPP
#define TEST_CORE_HIP_TEST_CONVERT_HPP
...
TYPED_TEST(ConvertTypesTest, ForwardHIP) {
...
TYPED_TEST(ConvertTypesTest, BackwardHIP) {
...
#endif  // TEST_CORE_HIP_TEST_CONVERT_HPP
