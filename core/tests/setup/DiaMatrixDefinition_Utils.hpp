/**
 * DiaMatrix_Definition_Utils.hpp
 *
...
#ifndef MORPHEUS_CORE_TESTS_DIAMATRIX_DEFINITION_UTILS_HPP
#define MORPHEUS_CORE_TESTS_DIAMATRIX_DEFINITION_UTILS_HPP

#include <setup/TypeDefinition_Utils.hpp>

template <typename ValueType, typename IndexType, typename ArrayLayout,
          typename Space>
struct DiaMatrixTypes {
